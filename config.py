...
# Video Path
VIDEO_CONFIG = {
	"VIDEO_CAP" : "../Crowd-Analysis/crowd_walking.mp4",
	"IS_CAM" : False,
	"CAM_APPROX_FPS": 3,
	"HIGH_CAM": False,
...
# YOLO_CONFIG = {
# 	"WEIGHTS_PATH" : "Crowd-Analysis\YOLOv4-tiny\yolov4-tiny.weights",
# 	"CONFIG_PATH" : "Crowd-Analysis\YOLOv4-tiny\yolov4-tiny.cfg"
# }
YOLO_CONFIG = {
